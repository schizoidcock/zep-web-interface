...
func GetMenuItems(basePath string) []MenuItem {
	...
	return []MenuItem{
		...
		},
		{
			...
			Icon: template.HTML(SessionsIcon),
		},
		{
			Name: "Settings",
			Path: basePath + "/settings",
			Icon: template.HTML(SettingsIcon),
		},
		{
			Name:     "Documentation",
			Path:     "https://docs.getzep.com",
			External: true,
			Icon:     template.HTML(DocsIcon),
		},
	}
}